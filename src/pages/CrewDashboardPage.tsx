...
import { MapPin, Clock, LogIn, LogOut, CheckCircle, AlertTriangle } from "lucide-react";
...
export default function CrewDashboardPage() {
  ...
  useEffect(() => {
    const fetchAssignedJobs = async () => {
      ...
      // Get job assignments for this team member's worker_id
  ...
  const handleCheckIn = async (job: AssignedJob) => {
    ...
    try {
      ...
      // Check geofence if site has coordinates
